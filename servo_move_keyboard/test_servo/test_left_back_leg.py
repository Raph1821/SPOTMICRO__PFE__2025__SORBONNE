...
# Left Back leg servos (channels 6, 7, 8)
LB_3 = 6   # Knee (genou)
LB_2 = 7  # Shoulder (épaule)
LB_1 = 8  # Hip (hanche)

print("Testing LEFT BACK LEG...")
print("Setting all servos to CENTER (306)...")
pca.set_pwm(LB_1, 306)
pca.set_pwm(LB_2, 306)
pca.set_pwm(LB_3, 306)
time.sleep(2)

print("\nTesting LB_1 (Hip - channel 8)...")
pca.set_pwm(LB_1, 200)
time.sleep(1)
pca.set_pwm(LB_1, 400)
time.sleep(1)
pca.set_pwm(LB_1, 306)
time.sleep(1)

print("\nTesting LB_2 (Shoulder - channel 7)...")
pca.set_pwm(LB_2, 200)
time.sleep(1)
pca.set_pwm(LB_2, 400)
time.sleep(1)
pca.set_pwm(LB_2, 306)
time.sleep(1)

print("\nTesting LB_3 (Knee - channel 6)...")
pca.set_pwm(LB_3, 200)
time.sleep(1)
pca.set_pwm(LB_3, 400)
time.sleep(1)
pca.set_pwm(LB_3, 306)
time.sleep(1)
