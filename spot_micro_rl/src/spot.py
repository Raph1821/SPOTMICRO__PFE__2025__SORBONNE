...
import numpy as np
from . import motor
from src.util import pybullet_data
print(pybullet_data.getDataPath())
from src.Kinematics.SpotKinematics import SpotModel
import src.Kinematics.LieAlgebra as LA
...
for name in MOTOR_NAMES:
    if "shoulder" in name:
        MOTOR_LIMITS_BY_NAME[name] = [-0.548, 0.548]
    elif "leg" in name:
        MOTOR_LIMITS_BY_NAME[name] = [-2.666, 1.548]
    elif "foot" in name:
        MOTOR_LIMITS_BY_NAME[name] = [-0.1, 2.59]
...
# For spot_micro_pybullet_gen_ros.urdf
_MOTOR_NAME_PATTERN = re.compile(r"(front|rear)_(left|right)_(shoulder|leg)$")
_FOOT_NAME_PATTERN  = re.compile(r"(front|rear)_(left|right)_foot$")
  ...
  """
        ...
        if reload_urdf:
            if self._self_collision_enabled:
                self.quadruped = self._pybullet_client.loadURDF(
                    pybullet_data.getDataPath() + "/assets/urdf/spot_micro_pybullet_gen_ros.urdf",
                    init_position,
                    INIT_ORIENTATION,
    ...
    """
        ...
        self._pybullet_client.resetJointState(
            ...
            # For spot_micro_pybullet_gen_ros.urdf
            self._joint_name_to_id[leg_position + "_shoulder"],
        ...
        self._pybullet_client.resetJointState(
            ...
            # For spot_micro_pybullet_gen_ros.urdf
            self._joint_name_to_id[leg_position + "_leg"],
        ...
        self._pybullet_client.resetJointState(
            ...
            # For spot_micro_pybullet_gen_ros.urdf
            self._joint_name_to_id[leg_position + "_foot"],
        ...
        if self._accurate_motor_model_enabled or self._pd_control_enabled:
            ...
            self._pybullet_client.setJointMotorControl2(
                ...
                # For spot_micro_pybullet_gen_ros.urdf
                jointIndex=(self._joint_name_to_id[leg_position + "_shoulder"]),
            ...
            self._pybullet_client.setJointMotorControl2(
                ...
                # For spot_micro_pybullet_gen_ros.urdf
                jointIndex=(self._joint_name_to_id[leg_position + "_leg"]),
                controlMode=self._pybullet_client.VELOCITY_CONTROL,
                targetVelocity=0,
                force=knee_friction_force)
            self._pybullet_client.setJointMotorControl2(
                ...
                # For spot_micro_pybullet_gen_ros.urdf
                jointIndex=(self._joint_name_to_id[leg_position + "_foot"]),
                controlMode=self._pybullet_client.VELOCITY_CONTROL,
                targetVelocity=0,
                force=knee_friction_force)
